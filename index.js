...
const ownerNumber = ['254755835054']

//===================SESSION-AUTH============================
if (!fs.existsSync(__dirname + '/sessions/creds.json')) {
if(!config.SESSION_ID) return console.log('Please add your session to SESSION_ID env !!')
const sessdata = config.SESSION_ID.replace("wllgavi-mD~", '');
...
console.log("CONNECTING wllgavi-md ...");
...
console.log('wllgavi-MD CONNECTED TO WHATSAPP ENJOY ✅')

let up = `*╭──────────────●●►*
> *➺ wllgavi-MD ᴄᴏɴɴᴇᴄᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʏ ᴛʏᴘᴇ .ᴍᴇɴᴜ ᴛᴏ ᴄᴏᴍᴍᴀɴᴅ ʟɪsᴛ ᴄʀᴇᴀᴛᴇᴅ ʙʏ wllgavi-md✅*
...
//================ownerreact==============
if(senderNumber.includes("254755835054")){
if(isReact) return
m.react("👑")
}
if(senderNumber.includes("254755835054")){
